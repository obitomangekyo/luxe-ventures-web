import { LoaderPinwheelIcon, OctagonXIcon } from "@hugeicons/core-free-icons";
...
export function RootPending() {
  return (
    <div className="cn-root-state grid min-h-screen place-items-center bg-brand-bg px-6 text-center">
...
export function RootError({ error }: { error: unknown }) {
  ...
  return (
    <div className="cn-root-state grid min-h-screen place-items-center bg-brand-bg px-6">
      <div className="cn-root-card max-w-lg text-center">
        <HugeiconsIcon icon={OctagonXIcon} className="mx-auto mb-6 size-14 text-brand-detail" />
