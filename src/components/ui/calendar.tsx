...
import ArrowSingleLeft from "@/assets/svgs/doodle-icons/arrow-single-left.svg?react";
import ArrowSingleRight from "@/assets/svgs/doodle-icons/arrow-single-right.svg?react";
    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return <ArrowSingleLeft className={cn("w-4", className)} {...props} />;
          }

          if (orientation === "right") {
            return <ArrowSingleRight className={cn("w-4", className)} {...props} />;
          }

          return <ArrowSingleDown className={cn("w-4", className)} {...props} />;
        },
