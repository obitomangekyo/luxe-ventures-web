    ...
    <DayPicker
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <HugeiconsIcon icon={ArrowLeft01Icon} className={cn("w-4", className)} {...props} />
            );
          }

          if (orientation === "right") {
            return (
              <HugeiconsIcon icon={ArrowRight01Icon} className={cn("w-4", className)} {...props} />
            );
          }

          return (
            <HugeiconsIcon icon={ArrowDown01Icon} className={cn("w-4", className)} {...props} />
          );
        },
