...
import ArrowSingleDown from "@/assets/svgs/doodle-icons/arrow-single-down.svg?react";
import ArrowSingleUp from "@/assets/svgs/doodle-icons/arrow-single-up.svg?react";
  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon
        render={<ArrowSingleDown className="pointer-events-none w-4 text-muted-foreground" />}
      />
    </SelectPrimitive.Trigger>
  );
}
...
function SelectItem({ className, children, ...props }: SelectPrimitive.Item.Props) {
  return (
    ...
    >
      ...
      >
        <Tick className="pointer-events-none h-full" />
      </SelectPrimitive.ItemIndicator>
    </SelectPrimitive.Item>
  );
}
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpArrow
      ...
      className={cn(
        "top-0 z-10 flex w-full cursor-default items-center justify-center bg-popover py-1 [&_svg:not([class*='size-'])]:h-4",
        className,
      )}
      {...props}
    >
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownArrow
      ...
      className={cn(
        "bottom-0 z-10 flex w-full cursor-default items-center justify-center bg-popover py-1 [&_svg:not([class*='size-'])]:h-4",
        className,
      )}
      {...props}
    >
