...
import geometricVenueEntranceAvif from "@/assets/images/luxe-ventures/geometric-venue-entrance.jpg?w=480;768;960&format=avif&as=srcset";
import geometricVenueEntranceWebp from "@/assets/images/luxe-ventures/geometric-venue-entrance.jpg?w=480;768;960&format=webp&as=srcset";
import geometricVenueEntranceJpg from "@/assets/images/luxe-ventures/geometric-venue-entrance.jpg?w=960&format=jpg";
...
export const imageAssets = {
  ...
  geometricVenueEntrance: {
    avif: geometricVenueEntranceAvif,
    webp: geometricVenueEntranceWebp,
    fallback: geometricVenueEntranceJpg,
  },
  intimateDinner: {
